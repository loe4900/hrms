...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="form-group form-row">
                    <label for="name" class="col col-form-label">部门名称:</label>
    ...
    <!-- 模态框 -->
    <div class="modal fade" id="deptModalCenter" tabindex="-1" role="dialog" aria-labelledby="deptModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deptModalLongTitle">标题</h5>
...
<script src="${basePath}/js/dept/hrms-dept.js"></script>
</html>