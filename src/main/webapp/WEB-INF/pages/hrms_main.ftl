...
<div class="row north">
    ...
    <div class="col-6 align-self-end text-right">
        <ul class="list-inline">
            ...
            <li class="list-inline-item">2018年5月24日 星期四 下午1:57</li>
        </ul>
    </div>
</div>
<div class="row main">
    ...
    <div class="col-9 page-wrapper">
        <iframe src='${basePath}/notice/welcome' width='100%' height='100%' frameborder='0' name='_blank'
                id='_blank'></iframe>
    </div>
</div>
</body>
        ...
        $('.menu li').click(function (event) {
            ...
            switch ($(this).text()) {
                case '欢迎使用':
                    ...
                    break;
                case '用户管理':
                    $('.page-wrapper').html("<iframe src='${basePath}/user' width='100%' height='100%' frameborder='0' name='_blank' id='_blank'></iframe>");
                    break;
                case '部门管理':
                    $('.page-wrapper').html("<iframe src='${basePath}/dept' width='100%' height='100%' frameborder='0' name='_blank' id='_blank'></iframe>");
                    break;
                case '职位管理':
                    $('.page-wrapper').html("<iframe src='${basePath}/job' width='100%' height='100%' frameborder='0' name='_blank' id='_blank'></iframe>");
                    break;
                case '员工管理':
                    $('.page-wrapper').html("<iframe src='${basePath}/employee' width='100%' height='100%' frameborder='0' name='_blank' id='_blank'></iframe>");
                    break;
                case '公告管理':
                    $('.page-wrapper').html("<iframe src='${basePath}/notice' width='100%' height='100%' frameborder='0' name='_blank' id='_blank'></iframe>");
                    break;
                case '下载中心':
